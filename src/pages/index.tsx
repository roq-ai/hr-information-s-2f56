  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Streamlining Employee Management, Vacation Planning, and Payroll Processing for Empowered Employers"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Streamlining Employee Management, Vacation Planning, and Payroll Processing for Empowered Employers`}
            </Text>
            <Box
